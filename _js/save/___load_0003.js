...
//	top.cSTR_STRG_UserInfo.Debug = wFlg ;
	////////////////////////////////////////
	//ロード
	_STRG_LOAD_CSV__0003__UserInfo_1() ;
	_STRG_LOAD_CSV__0003__UserInfo_2() ;
...
// [4]: 更新日時
////////////////////////////////////////
function _STRG_LOAD_CSV__0003__UserInfo_1()
{
...
// [9]: 高速建造
////////////////////////////////////////
function _STRG_LOAD_CSV__0003__UserInfo_2()
{
	if( top.cSTR_STRG_SaveInfo.FlgError==true )
	{/////エラー中
		return false ;
